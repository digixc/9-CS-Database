...
:HTML_CONTAINER_CLASS: try
:END: 
- *Starter* - Click to test your knowledge of database terminology: [[http://www.teach-ict.com/gcse_new/databases/terminology/quiz/invaders_dbterminology.htm]]
#+BEGIN_HTML
...
- *Plenary* - Using your knowledge of databases so far, have a go at the *Query Quiz*
   #+BEGIN_HTML
    <object width="400" height="400" data="doc/Query Quiz.swf"></object>
   #+END_HTML
    [[./img/L2MatchupQuiz.jpg]]
