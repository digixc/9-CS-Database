...
* Database - End of Unit Self Evaluation
:PROPERTIES:
:HTML_CONTAINER_CLASS: activity
:END:
...
:HTML_CONTAINER_CLASS: try
:END:
- [[./doc/Databases_End_of_unit_Evaluation.docx][ Right click here]] then *Save Link As* to save this evaluation template into your homedrive.
